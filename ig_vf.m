function [e,h,v] = ig_vf(ledx_cm,ledy_cm,sx_minarc,sy_minarc,vd_cm)
...
%		e		- eccentricity (deg)
% Usage:	[e,h,v] = ig_vf(ledx_cm,ledy_cm,sx_minarc,sy_minarc,vd_cm);
%		e = ig_vf(h_deg, v_deg);
%
...
%
% See also IG_CM2MINARC, IG_MINARC2CM.
%--------------------------------------------------------------------------------
