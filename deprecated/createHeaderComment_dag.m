function comment = createHeaderComment_dag(hDocument, eventData)
mfile_name = mfilename; disp_ig_warning(mfile_name);
% createHeaderComment_dag  - adds mfile header template to currently open file in matlab editor
%
% USAGE:	
%		After opening MATLAB
%		1) >> EditorMacro('Alt-Control-h', @createHeaderComment_dag);
