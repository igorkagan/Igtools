function copy_dir(fromdir,todir,do_not_copy_dirs,avoid,verbose)
mfile_name = mfilename; disp_ig_warning(mfile_name);
% copy all files in directory "fromdir" to directory "todir" except avoid
% copy_dir('Z:\MRI\Curius\20141017','Y:\MRI\Curius\20141017',1,'.zip')
