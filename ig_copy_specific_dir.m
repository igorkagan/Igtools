function ig_copy_specific_dir(fromdir,todir,specific_dir,move,verbose)
%IG_COPY_SPECIFIC_DIR		- copy specific_dir in directory "fromdir" to directory "todir"
% ig_copy_specific_dir('/data1/MRI/Florian/20100125','/mnt/hylobates/MRI/Florian/20100125','im',1);
